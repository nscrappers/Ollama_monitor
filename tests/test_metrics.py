...
class TestFetchMetrics:
    ...
    # I often run a second Ollama instance on port 11435 for testing model
    # changes without affecting my main instance, so this covers that case.
    def test_alternate_local_port(self):
